    ...
    if request.method == "GET":
        ...
        if request.POST['password1'] == request.POST['password2']:
            try:
                ...
                return render(request, 'todo/usersignup.html', {'form': UserCreationForm(), 'error': 'That username has already been taken. Please choose a new one.'})
        else:
...
def viewtodo(request, todo_pk):
    ...
    if request.method == "GET":
        ...
        try:
            ...
            return render(request, 'todo/createtodo.html', {'todo':Todo, 'form':form, 'error':'Bad data passed in. Try again.'})
